...
internal class Repository
{
    ...
    public List<Worker> GetAllWorkers()
    {
        ...
        List<Worker> existingWorkers = new();
    ...
    public Worker GetWorkerById(int id, List<Worker> existingWorkers)
    {
    ...
    public void DeleteWorker(int id, List<Worker> existingWorkers)
    {
        Worker workerToDelete = GetWorkerById(id, existingWorkers);
    ...
    public List<Worker> GetWorkersBetweenTwoDates(DateTime dateFrom, DateTime dateTo, List<Worker> existingWorkers)
    {
    ...
    public void CheckIfFileExistAndCreate()
    {
